package com.defaz.joel.cazarpatos
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initializeScreen()              //Determina el ancho y largo de pantalla
        initializeCountdown()           //Cuenta regresiva del juego
    ...
    private fun moveDuckRandomly() {
        val min = imageViewDuck.getWidth()/20
        ...
        val randomY = Random.nextInt(120,maximoY - min + 1)
